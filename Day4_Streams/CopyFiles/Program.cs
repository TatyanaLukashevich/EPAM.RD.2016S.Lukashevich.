...
namespace FileStreams
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            string source = @"d:\current.txt";
            string destin = @"d:\destin.txt";
        ...
        public static void MemoryBufferCopy(string source, string destin)
        {
            ...
            using (var stringReader = new StreamReader(source)) // TODO: Use StringReader to read from stringBuilder.
        ...
        public static void WebClient()
        {
            ...
            {
                using (var outputStream = new FileStream(@"D:\Google.txt", FileMode.Create))
                {
